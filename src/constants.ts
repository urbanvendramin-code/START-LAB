...
export const WORKSHOPS = [
  ...
  },
  {
    ...
    items: [
      { id: 'electronics-racer', title: 'Spoznaj svet elektronike in izdelaj svojega prvega dirkača!', description: 'Razstavi elektronske naprave, odkrij delovanje komponent in vezij ter sestavi svojega delujočega elektronskega dirkača, ki ga odneseš domov.', icon: Zap, image: 'https://res.cloudinary.com/dssxhjk8k/image/upload/v1786955456/elektronika2_gqkovv.jpg' },
