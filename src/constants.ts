...
export const WORKSHOPS = [
  ...
  },
  {
    ...
    items: [
      { id: 'electronics-racer', title: 'Spoznaj svet elektronike in izdelaj svojega prvega dirkača!', description: 'Razstavi naprave, spoznaj osnove elektrike in nizkonapetostnih vezij ter sestavi svojega delujočega elektronskega dirkača, ki ga odneseš domov.', icon: Zap, image: 'https://res.cloudinary.com/dssxhjk8k/image/upload/v1786692547/elektronika_hiap6z.jpg' },
